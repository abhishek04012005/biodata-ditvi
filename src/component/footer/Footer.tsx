      ...
      <div className={styles.footerWrapper}>
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerDescription}>
              Expert biodata design and career support for traditionals who want to stand out with confidence.
            </p>
        ...
        <div className={styles.footerBottom}>
          <div className={styles.footerCopyright}>
            <p>
              Ditvi Biodata is a unit of <strong>Ditvi Foundation</strong> | © {new Date().getFullYear()} Ditvi Biodata. All rights reserved.
            </p>
          </div>
